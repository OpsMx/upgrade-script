...
// GetJiraId returns AddJiraInput.JiraId, and is useful for accessing the field via an interface.
func (v *AddJiraInput) GetJiraId() string { return v.JiraId }

// GetUrl returns AddJiraInput.Url, and is useful for accessing the field via an interface.
func (v *AddJiraInput) GetUrl() string { return v.Url }

// GetStatus returns AddJiraInput.Status, and is useful for accessing the field via an interface.
func (v *AddJiraInput) GetStatus() string { return v.Status }

// GetCreatedAt returns AddJiraInput.CreatedAt, and is useful for accessing the field via an interface.
func (v *AddJiraInput) GetCreatedAt() *time.Time { return v.CreatedAt }

// GetUpdatedAt returns AddJiraInput.UpdatedAt, and is useful for accessing the field via an interface.
func (v *AddJiraInput) GetUpdatedAt() *time.Time { return v.UpdatedAt }

// GetAffectsIndividualComponent returns AddJiraInput.AffectsIndividualComponent, and is useful for accessing the field via an interface.
func (v *AddJiraInput) GetAffectsIndividualComponent() *RunHistoryRef {
	return v.AffectsIndividualComponent
}

// GetAffectsSecurityissue returns AddJiraInput.AffectsSecurityissue, and is useful for accessing the field via an interface.
func (v *AddJiraInput) GetAffectsSecurityissue() *SecurityIssueRef { return v.AffectsSecurityissue }
...
// AttachJiraToRunHistoryAddJiraAddJiraPayload includes the requested fields of the GraphQL type AddJiraPayload.
type AttachJiraToRunHistoryAddJiraAddJiraPayload struct {
	NumUids *int `json:"numUids"`
}

// GetNumUids returns AttachJiraToRunHistoryAddJiraAddJiraPayload.NumUids, and is useful for accessing the field via an interface.
func (v *AttachJiraToRunHistoryAddJiraAddJiraPayload) GetNumUids() *int { return v.NumUids }

// AttachJiraToRunHistoryResponse is returned by AttachJiraToRunHistory on success.
type AttachJiraToRunHistoryResponse struct {
	AddJira *AttachJiraToRunHistoryAddJiraAddJiraPayload `json:"addJira"`
}

// GetAddJira returns AttachJiraToRunHistoryResponse.AddJira, and is useful for accessing the field via an interface.
func (v *AttachJiraToRunHistoryResponse) GetAddJira() *AttachJiraToRunHistoryAddJiraAddJiraPayload {
	return v.AddJira
}
...
// __AttachJiraToRunHistoryInput is used internally by genqlient
type __AttachJiraToRunHistoryInput struct {
	Jira []*AddJiraInput `json:"jira,omitempty"`
}

// GetJira returns __AttachJiraToRunHistoryInput.Jira, and is useful for accessing the field via an interface.
func (v *__AttachJiraToRunHistoryInput) GetJira() []*AddJiraInput { return v.Jira }

// The query or mutation executed by AttachJiraToRunHistory.
const AttachJiraToRunHistory_Operation = `
...
func AttachJiraToRunHistory(
	ctx_ context.Context,
	client_ graphql.Client,
	jira []*AddJiraInput,
) (*AttachJiraToRunHistoryResponse, error) {
	req_ := &graphql.Request{
		OpName: "AttachJiraToRunHistory",
		Query:  AttachJiraToRunHistory_Operation,
		Variables: &__AttachJiraToRunHistoryInput{
			Jira: jira,
		},
	}
	var err_ error
